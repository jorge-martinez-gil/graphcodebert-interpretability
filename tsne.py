...
# Loop over each pair and generate the visualizations using t-SNE
for (algo1_name, algo2_name) in algorithm_pairs:
    ...
    output_file = os.path.join(output_dir, f"{algo1_name}_vs_{algo2_name}_tokens_2d_tsne.png")
    plt.savefig(output_file, format='png', dpi=300, bbox_inches='tight')

    # Show the plot
    plt.close()

print("All pairwise comparison images using t-SNE have been generated.")
